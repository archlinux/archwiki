		...
		[
			...
			'\n',
			{
				...
				attributes: {
					...
					originalMw: '{"name":"ref","attrs":{"details":"page 123"},"body":{"id":"mw-reference-text-cite_note-5"},"mainBody":"mw-reference-text-cite_note-book-4","mainRef":"book"}',
					listIndex: 3,
					listGroup: 'mwReference/',
					listKey: 'auto/1',
					refGroup: '',
