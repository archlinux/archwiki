...
class SimpleCaptcha {
	...
	/** @var array<string,true> Activated captcha status list for a pages by key */
	...
	/**
	 * Returns a list of pages with a key generated by {@see CacheKeyHelper::getKeyForPage}, that have activated
	 * captchas.
	 *
