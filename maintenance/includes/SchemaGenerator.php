...
class SchemaGenerator {
	...
	private function makeSQLComment( string $scriptName, string $jsonPath ): string {
		...
		$canonicalJsonPath = $this->normalizePath( $jsonPath, MW_INSTALL_PATH, $wgExtensionDirectory );
	 ...
	 * @param string $installPath Value of MW_INSTALL_PATH
	 * @param string $extensionDirectory Value of $wgExtensionDirectory
	...
	public static function normalizePath(
		...
		if ( str_starts_with( $jsonPath, $extensionDirectory ) ) {
			// Strip $wgExtensionDirectory which might be configured outside of MW_INSTALL_PATH
			...
			// For mediawiki/core we strip MW_INSTALL_PATH
